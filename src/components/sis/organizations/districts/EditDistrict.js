...
import EditDistrictSkeleton from './EditDistrictSkeleton'

const CheckboxWithGreenCheck = withStyles({})(Checkbox)

function EditDistrict({ masterData, editDistrict, district, formState, editLogo }) {
  ...
  const breadcrumbData = [
    ...
    {
      title: t('breadcrumbEditDistrict'),
      href: '',
    },
  ]
  if (isEmpty(district)) {
